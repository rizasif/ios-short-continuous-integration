...
class RomanNumeralCalculatorUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        // XCUIApplication().orientation = .portrait
    }
    ...
    func testAddOnePlusOne(){
        ...
        let calculated_label = app.staticTexts["calculated_value"].tap()

        //tap I
        iButton.tap()
        XCTAssertEqual(app.staticTexts["calculated_value"].label, "I")
        ...
        //tap I
        iButton.tap()
        XCTAssertEqual(app.staticTexts["calculated_value"].label, "II")
    }
